// This sketch is for a ST7789 display. It draws a rectangle in the center of the screen and fills it with 
random colors.
// It also plays a melody using the tone function. The melody is defined in the midi() function.
